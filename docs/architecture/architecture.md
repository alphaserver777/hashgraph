...
- Production-контур самодостаточного Linux-контейнера узла пока не реализован, но зафиксирован как следующее архитектурное направление в `docs/tasks/006-self-contained-linux-node-container.md`.
...
- Спроектировать и затем отдельно реализовать самодостаточный Linux-контейнер узла, который внутри себя объединяет сбор событий, runtime MDRJ-DAG, локальную БД и UI.
